			...
			try {
				...
				if (partidaXadrez.getJogadorAtual() == Cor.BRANCA) {
					...
					if (partidaXadrez.getCheque() == true) {
						Interface.imprimirTabuleiroEmCheque(partidaXadrez.getPecas(), movimentosPossiveis, Interface.fundoVermelho);
					} else {
				         Interface.imprimirTabuleiro(partidaXadrez.getPecas(), movimentosPossiveis, Interface.fundoAzul);
					}
				} 
				...
				//TAMBÉM TEM A OPÇÃO DE IMPRIMIR EM CHEQUE (VERMELHO) NA VISÃO DAS PRETAS
					...
					if (partidaXadrez.getCheque() == true) {
						Interface.imprimirTabuleiroInvertidoEmCheque(partidaXadrez.getPecas(), movimentosPossiveis, Interface.fundoVermelho);
					} else {
					Interface.imprimirTabuleiroInvertido(partidaXadrez.getPecas(), movimentosPossiveis, Interface.fundoAzul);
					}
				}
