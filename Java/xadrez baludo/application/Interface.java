...
System.out.print(roxo+":"+ANSI_RESET);	
	...
	public static void imprimirPecasCapturadas(List<PecaXadrez> pecasCap) {
		...
		if (peoesCapturados.isEmpty()) {
			...
			listaPecas += Arrays.toString(peoesCapturados.toArray());
			listaPecas = listaPecas.replace("P, P", "PP");
		}
		...
		if (bisposCapturados.isEmpty()) {
			...
			listaPecas += Arrays.toString(bisposCapturados.toArray());
			listaPecas = listaPecas.replace("B, B", "BB");
		}
		...
		if (cavalosCapturados.isEmpty()) {
			...
			listaPecas += Arrays.toString(cavalosCapturados.toArray());
			listaPecas = listaPecas.replace("C, C", "CC");
		}
		...
		if (damasCapturadas.isEmpty()) {
			...
			listaPecas += Arrays.toString(damasCapturadas.toArray());
		}
		...
		if (torresCapturadas.isEmpty()) {
			...
			listaPecas += Arrays.toString(torresCapturadas.toArray());
			listaPecas = listaPecas.replace("T, T", "TT");
		}
